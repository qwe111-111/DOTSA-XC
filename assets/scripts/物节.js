...
const lib = require('base/lib');//引用该文件
...
const blockType = extend(StorageBlock, "物品节点", {
    load() {
        this.super$load();
        topRegion = lib.loadRegion("物品节点-top");
        bottomRegion = lib.loadRegion("物品节点-bottom");
        rotatorRegion = lib.loadRegion("物品节点-rotator");
    },
